public class Nomi {
	...
	public Nomi() {
		nomi = new String[] {"Bulbasaur", "Ivysaur", "Venosaur", "Charmander", "Charmeleon", "Charizard",
			...
			"Lotad", "Lombre", "Ludicolo", "Seedot", "Nuzleaf", "Shiftry", "Taillow", "Swellow",
			...
			"Castform", "Kecleon", "Shuppet", "Banette", "Duskull", "Dusclops", "Tropius", "Chimecho",
			...
			"Rotom", "Uxie", "Mesprit", "Azelf",
			"Dialga", "Palkia", "Heatran", "Regigigas", "Giratina",
			"Cresselia", "Phione", "Manaphy", "Darkrai", "Shaymin",
			"Arceus"
		};
	}
